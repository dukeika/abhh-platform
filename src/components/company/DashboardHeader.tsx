              ...
              <div className="flex items-center space-x-3">
                <div className="text-right">
                  ...
                  <p className="text-xs text-abhh-teal-500">
                    {userRecord ? `${userRecord.firstName} ${userRecord.lastName}` : user?.username}
                  </p>
                </div>
                <div className="w-8 h-8 bg-abhh-teal-100 rounded-full flex items-center justify-center">
                  <span className="text-xs font-semibold text-abhh-teal-600">
                    {userRecord ? userRecord.firstName?.charAt(0)?.toUpperCase() : user?.username?.charAt(0)?.toUpperCase() || "C"}
                  </span>
                </div>
                <Button
                  onClick={signOut}
